  ...
  announcement: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'handle' | 'type'> & {
        ...
        >;
        startDate?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        endDate?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
      }
    >;
...
type MediaFieldsByType_MediaImage_Fragment = {
  image?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Image, 'url' | 'altText' | 'width' | 'height'>
  >;
};

type MediaFieldsByType_Model3d_Fragment = {
  sources: Array<
    Pick<
...
type MediaFieldsByType_Video_Fragment = {
  sources: Array<
    Pick<
...
export type MediaFieldsByTypeFragment =
  | MediaFieldsByType_ExternalVideo_Fragment
  | MediaFieldsByType_MediaImage_Fragment
  | MediaFieldsByType_Model3d_Fragment
  | MediaFieldsByType_Video_Fragment;
...
> & {
    ...
    edges: Array<{
      node:
        | ({__typename: 'ExternalVideo'} & Pick<
            StorefrontAPI.ExternalVideo,
            'id' | 'mediaContentType' | 'embeddedUrl'
          > & {
              previewImage?: StorefrontAPI.Maybe<
                Pick<
                  StorefrontAPI.Image,
  ...
  productFeatures?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
  transformYourAssetManagement?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
  perfectFor?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
  whatOurClientsSay?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
  extraInfo?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
  howToUse?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
  shipping?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
  returnPolicy?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type' | 'key'>
  >;
};
